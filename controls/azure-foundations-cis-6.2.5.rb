control 'azure-foundations-cis-6.2.5' do
  ...
  powershell_output = powershell(activity_log_exists_create_update_ss_script)
  describe 'Ensure that the subscriptions output for the activity log alert rule for Creating/Updating a Security Solution' do
