control 'azure-foundations-cis-6.2.6' do
  ...
  pwsh_output = powershell(activity_log_exists_delete_ss_script)
  describe 'Ensure that the subscription`s output for the activity log alert rule for Deleting a Security Solution' do
