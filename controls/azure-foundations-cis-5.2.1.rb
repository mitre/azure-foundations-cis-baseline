control 'azure-foundations-cis-5.2.1' do
  ...
  if rg_sa_list.empty?
    ...
    resource_groups.each do |resource_group|
      ...
      postgres_output = postgres_servers_output_pwsh.stdout.strip
      postgres_servers = json(content: postgres_output).params
    ...
    describe 'PostgreSQL Flexible servers with require_secure_transport not set to ON' do
      subject { failures }
      it { should be_empty }
    end
  end
