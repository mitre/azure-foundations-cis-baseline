control 'azure-foundations-cis-6.2.2' do
  ...
  powershell_output = powershell(activity_log_exists_dpa_script)
  describe 'Ensure the subscription that the output from checking the activity log alert rule for Delete Policy Assignments' do
